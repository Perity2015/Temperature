...
public class NFCCommand {
	...
	//* the argument myTag is the intent triggered with the TAG_DISCOVERED
	//***********************************************************************/
	//public static byte[] SendGetSystemInfoCommandCustom_Inventory (Tag myTag, MainApp ma)
	public static byte[] SendGetSystemInfoCommandCustom(Tag myTag, MainApp ma) {
	...
	//* the argument myTag is the intent triggered with the TAG_DISCOVERED
	//***********************************************************************/
	public static byte[] SendGetSystemInfoCommandCustom_v3(Tag myTag, MainApp ma) {
		int cpt = 0;
		byte[] response = new byte[]{(byte) 0xAA};
		byte[] GetSystemInfoFrame = new byte[2];
	...
	//* the argument myTag is the intent triggered with the TAG_DISCOVERED
	//***********************************************************************/
	public static byte[] SendGetSystemInfoCommandCustom_OLD(Tag myTag, MainApp ma) {
	...
	//***********************************************************************/
	public static byte[] SendReadSingleBlockCommand(Tag myTag, byte[] StartAddress, MainApp ma) {
	...
	//* According to the ISO-15693 maximum block read is 32 for the same sector
	//***********************************************************************/
	public static byte[] SendReadMultipleBlockCommandCustom(Tag myTag, byte[] StartAddress, byte NbOfBlockToRead, MainApp ma) {
		long cpt = 0;
	...
	public static byte[] SendReadMultipleBlockCommandCustom_JPG(Tag myTag, byte[] StartAddress, byte NbOfBlockToRead, MainApp ma) {
		long cpt = 0;
	...
	public static byte[] Send_several_ReadSingleBlockCommands(Tag myTag, byte[] StartAddress, byte[] bytNbBytesToRead, MainApp ma) {
		long cpt = 0;
		boolean checkCorrectAnswer = true;
	...
	public static byte[] Send_several_ReadSingleBlockCommands_NbBlocks(Tag myTag, byte[] StartAddress, byte[] bNbOfBlockToRead, MainApp ma) {
		long cpt = 0;
		boolean checkCorrectAnswer = true;
	...
	public static byte[] Send_several_ReadSingleBlockCommands_NbBlocks_JPG(Tag myTag, byte[] StartAddress, byte[] bNbOfBlockToRead, MainApp ma) {
		long cpt = 0;
		boolean EndOfJpgFile = false;
		boolean checkCorrectAnswer = true;
	...
	public static byte[] SendReadMultipleBlockCommandCustom2(Tag myTag, byte[] StartAddress, byte[] bNbOfBlockToRead, MainApp ma) {
		...
		int iNumberOfBlockToIgnoreInAllReadData1 = 4 * (Helper.Convert2bytesHexaFormatToInt(StartAddress) % 32);
		byte[] AllReadDatas = new byte[((iNumberOfSectorToRead * 128) + 1 + iNumberOfBlockToIgnoreInAllReadData1)];
		byte[] FinalResponse = new byte[(iNbOfBlockToRead * 4) + 1];
		...
		for (int h = 1; h <= iNbBlockToCopyInFinalReponse * 4; h++) {
			//if(h>=FinalResponse.length || AllReadDatas.length>= h+ iNbBlockToCopyInFinalReponse*4)
			//{
			//    int nError;
			//}
	...
	public static byte[] SendReadMultipleBlockCommandCustom2_JPG(Tag myTag, byte[] StartAddress, byte[] bNbOfBlockToRead, MainApp ma) {
		boolean checkCorrectAnswer = true;
		boolean EndOfJpgFile = false;
	...
	public static byte[] Send_several_ReadMultipleBlockCommands(Tag myTag, byte[] bytNbBytesToRead, MainApp ma) {
		long cpt = 0;
		boolean checkCorrectAnswer = true;
	...
	//* According to the ISO-15693 maximum block read is 32 for the same sector
	//***********************************************************************/
	public static byte[] SendReadMultipleBlockCommand(Tag myTag, byte[] StartAddress, byte NbOfBlockToRead, MainApp ma) {
		byte[] response = new byte[]{(byte) 0x01};
	...
	//***********************************************************************/
	public static byte[] SendWriteSingleBlockCommand(Tag myTag, byte[] StartAddress, byte[] DataToWrite, MainApp ma) {
	...
	//* the function will write {0x04 0x14 0xFF 0xB2} at the address 0002
	//***********************************************************************/
	public static byte[] SendWriteMultipleBlockCommand(Tag myTag, byte[] StartAddress, byte[] DataToWrite, MainApp ma) {
		byte[] response = new byte[]{(byte) 0x01};
		long cpt = 0;
	...
	//* the function will write {0x04 0x14 0xFF 0xB2} at the address 0002
	//***********************************************************************/
	public static byte[] SendPresentPasswordCommand(Tag myTag, byte PasswordNumber, byte[] PasswordData, MainApp ma) {
		byte[] response = new byte[]{(byte) 0xFF};
	...
	//* the function will write {0x04 0x14 0xFF 0xB2} at the address 0002
	//***********************************************************************/
	public static byte[] SendWritePasswordCommand(Tag myTag, byte PasswordNumber, byte[] PasswordData, MainApp ma) {
		byte[] response = new byte[]{(byte) 0xFF};
		byte[] PresentPasswordFrame;
	...
	//* the function will write {0x04 0x14 0xFF 0xB2} at the address 0002
	//***********************************************************************/
	public static byte[] SendLockSectorCommand(Tag myTag, byte[] SectorNumberAddress, byte LockSectorByte, MainApp ma) {
		byte[] response = new byte[]{(byte) 0xFF};
	...
	//* According to the ISO-15693 maximum block read is 32 for the same sector
	//***********************************************************************/
	public static byte[] SendReadEHconfigCommand(Tag myTag, MainApp ma) {
		byte[] response = new byte[]{(byte) 0x0A};
	...
	//* the function will write {0x04 0x14 0xFF 0xB2} at the address 0002
	//***********************************************************************/
	public static byte[] SendWriteEHconfigCommand(Tag myTag, byte EHconfigByte, MainApp ma) {
		byte[] response = new byte[]{(byte) 0xFF};
	...
	//* the function will write {0x04 0x14 0xFF 0xB2} at the address 0002
	//***********************************************************************/
	public static byte[] SendWriteD0configCommand(Tag myTag, byte D0configByte, MainApp ma) {
		byte[] response = new byte[]{(byte) 0xFF};
	...
	//* According to the ISO-15693 maximum block read is 32 for the same sector
	//***********************************************************************/
	public static byte[] SendCheckEHenableCommand(Tag myTag, MainApp ma) {
		byte[] response = new byte[]{(byte) 0x0A};
		byte[] ReadEHconfigFrame;
	...
	//* According to the ISO-15693 maximum block read is 32 for the same sector
	//***********************************************************************/
	public static byte[] SendResetEHenableCommand(Tag myTag, MainApp ma) {
		byte[] response = new byte[]{(byte) 0x0A};
	...
	//* According to the ISO-15693 maximum block read is 32 for the same sector
	//***********************************************************************/
	public static byte[] SendSetEHenableCommand(Tag myTag, MainApp ma) {
		byte[] response = new byte[]{(byte) 0x0A};
